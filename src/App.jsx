              ...
              0 ? (
                ...
                <div className="student-empty-courses">
                  ...
                  <p>
                    ...
                    أول ما يتم إضافة أي كورس

                    إلى حسابك هتلاقيه ظاهر

                    هنا وتقدر تبدأ المذاكرة
            ...
            <div className="instructions-modal">
              ...
              <div className="instructions-list">
                ...
                <p>
                  ...
                  يجب كتابة بيانات صحيحة

                  خاصة رقم الطالب ورقم ولي
                ...
                <p>
                  ...
                  اختر نوع الطالب بشكل صحيح:

                  طالب سنتر أو طالب أونلاين.
                ...
                <p>
                  ...
                  يجب الالتزام بمشاهدة

                  الفيديوهات وحل الواجب
      ...
      >
        ...
        <section className="intro-section reveal-right">
          ...
          <p>
            ...
            شرحًا مبسطًا، واختبارات

            دورية، ومحتوى احترافي

            يساعدك على إتقان اللغة
            ...
            <div className="subscription-list">
              ...
              <div className="subscription-item reveal-up delay-2">
                ...
                <h3>
                  ...
                  تنظيم الدروس والوحدات

                </h3>

                <p>

                  محتوى مرتب ومقسم بطريقة

                  سهلة تساعدك تذاكر بدون
              ...
              <div className="subscription-item reveal-up delay-3">
                ...
                <p>
                  ...
                  فيديوهات وشرح سلس يخليك

                  تفهم القواعد والتطبيقات
              ...
              <div className="subscription-item reveal-up delay-4">
                ...
                <p>
                  ...
                  تقييم مستمر بعد كل جزء

                  علشان تعرف مستواك وتتطور
              ...
              <div className="subscription-item reveal-up delay-5">
                ...
                <h3>
                  ...
                  مراجعات ومحتوى احترافي

                </h3>

                <p>

                  مراجعات منظمة ومحتوى

                  يساعدك تدخل الامتحان
        ...
        <section className="stages-section">
          ...
          <div className="stages-heading reveal-up delay-1">
            ...
            <p>
              ...
              اختر الصف المناسب وابدأ

              رحلتك مع الشرح والاختبارات
            ...
            <article className="stage-card reveal-up delay-3">
              ...
              <div className="stage-overlay">
                ...
                <h3>
                  ...
                  محتوى الثاني الثانوي

                </h3>

                <p>

                  شرح مبسط، تدريبات متنوعة

                  واختبارات تساعدك تتابع
            ...
            <article className="stage-card reveal-up delay-4">
              ...
              <div className="stage-overlay">
                ...
                <h3>
                  ...
                  محتوى الثالث الثانوي

                </h3>

                <p>

                  مراجعات شاملة، اختبارات

                  ونماذج امتحانات تساعدك
